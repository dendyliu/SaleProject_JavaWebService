...
public class del_db extends HttpServlet {
    ...
    private int delProduct(java.lang.String accessToken, java.lang.String productId) throws IOException_Exception, ParseException_Exception {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        DelProductWS.DelProductWS port = service.getDelProductWSPort();
        return port.delProduct(accessToken, productId);
    }
