...
public class confirm_db extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            status= confirmPurchase(access_token,productId,quantity,consignee,fulladdress,postalcode,phonenumber,creditcard,verification);
    ...
    private int confirmPurchase(java.lang.String accessToken, java.lang.String productId, java.lang.String quantity, java.lang.String consignee, java.lang.String fulladdress, java.lang.String postalcode, java.lang.String phonenumber, java.lang.String creditcard, java.lang.String verification) throws IOException_Exception, ParseException_Exception {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        ConfirmWS.ConfirmWS port = service.getConfirmWSPort();
        return port.confirmPurchase(accessToken, productId, quantity, consignee, fulladdress, postalcode, phonenumber, creditcard, verification);
    }
