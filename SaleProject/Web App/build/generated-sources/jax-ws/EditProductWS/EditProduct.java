 ...
 *         &lt;element name="img_byte" type="{http://www.w3.org/2001/XMLSchema}base64Binary" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class EditProduct {
    ...
    @XmlElementRef(name = "img_byte", type = JAXBElement.class, required = false)
    protected JAXBElement<byte[]> imgByte;
    ...
    /**
     * Gets the value of the imgByte property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<byte[]> getImgByte() {
        return imgByte;
    }

    /**
     * Sets the value of the imgByte property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link byte[]}{@code >}
     *     
     */
    public void setImgByte(JAXBElement<byte[]> value) {
        this.imgByte = value;
    }
